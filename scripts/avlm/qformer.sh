...
fusion_mode="qformer"
run_name="avlm_qformer_pretrain_attention_drop_${drop_audio_ratio}"
...
export CUDA_VISIBLE_DEVICES=0,1,2,3; python $REPO/src/task/train_avlm.py \
    --num_gpus 1 \
