# AVLM Speech Only Training Script
...
drop_audio_ratio=0.3
fusion_mode="asr_only"
run_name="avlm_speech_only_pretrain_attention_drop_${drop_audio_ratio}"
...
export CUDA_VISIBLE_DEVICES=4,5,6,7; python $REPO/src/task/train_avlm.py \
    --num_gpus 4 \
